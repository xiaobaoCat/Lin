...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMaxCollapsedLines = typedArray.getInt(R.styleable.ExpandableTextView_maxCollapsedLines, MAX_COLLAPSED_LINES);//内容TextView未展开时显示的最大行数后
        mContentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, DEFAULT_CONTENT_TEXT_SIZE);//内容TextView的字体大小
        mContentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, Color.BLACK);//内容TextView的字体颜色

        mStateTvGravity = typedArray.getInt(R.styleable.ExpandableTextView_DrawableAndTextGravity, STATE_TV_GRAVITY_RIGHT);//展开按钮TextView的显示位置
        mStateTextColor = typedArray.getColor(R.styleable.ExpandableTextView_expandCollapseTextColor, Color.GREEN);//展开按钮TextView的字体颜色
        mExpandString = typedArray.getString(R.styleable.ExpandableTextView_expandText);//展开按钮TextView收起状态时显示的文字
        mCollapsedString = typedArray.getString(R.styleable.ExpandableTextView_collapseText);//展开按钮TextView展开状态时显示的文字
        mExpandDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_expandDrawable);//展开按钮TextView收起状态时Drawable的图片
        mCollapseDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_collapseDrawable);//展开按钮TextView展开状态时Drawable的图片
